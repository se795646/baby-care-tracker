...
- **🎙️ 語音智慧記錄 (新功能！)**
  ...
  - **口語指令解析**：智慧辨識「餵奶 120cc」、「睡了半小時」、「寶寶大便了」、「尿尿和大便了」、「大便綠色稀稀的」等口語指令，自動解析為結構化的喝奶、睡眠、以及大便/尿尿（含九色卡顏色與狀態）之記錄。

- **🧷 尿布更換與兒科健康提醒 (新功能！)**
  - **大便黃金九色卡比對**：提供符合小兒科醫學會之大便顏色選擇（7-9號正常；1-6號灰白/淡黃異常；血便/黑便警示），當選中異常時會即時展示紅色專業醫學就醫提示，並建議家長拍照。
  - **尿液脫水監控**：今日總尿布更換次數若少於 6 次，會顯示「注意水分補充足夠」的警告，並在衛教資訊中提醒留意結晶尿現象。
  - **資料相容儲存**：細部屬性以 JSON 序列化形式妥善存入現行資料表的 `note` 欄位中，**完美相容 Supabase 資料庫，不需任何 Schema 遷移**。
