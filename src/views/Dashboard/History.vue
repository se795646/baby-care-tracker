                    ...
                    >
                        <div class="bq-flex bq-items-start bq-gap-4">
                            ...
                            <div>
                                ...
                                <div
                                    class="bq-mt-1 bq-text-xs bq-text-gray-500"
                                >
                        ...
                        >
                            ...
                            <button
                                type="button"
                                class="bq-rounded-8 bq-px-3 bq-py-1.5 bq-text-xs bq-font-bold bq-text-red-500 bq-transition hover:bq-bg-red-50 hover:bq-text-red-700 active:bq-scale-95"
